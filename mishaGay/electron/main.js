...
const getTemplatePath = () => {
  ...
  const rootPath = path.join(__dirname, "resources/lermontov.xlsx");
...
// ─────────────────────────────────────────────────────────────────────────────
// IPC: Оффлайн-генерация Excel по шаблону
// ─────────────────────────────────────────────────────────────────────────────

ipcMain.handle("generate-offline-excel", async (_, { contractData, filename }) => {
